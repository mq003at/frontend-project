...
var ProductFullDetails = function (props) {
    var catName = props.catName, product = props.product;
    ...
    function handleButton() {
        dispatch(cartReducer_1.updateCart({ product: product, quantity: value }));
    }
        ...
        React.createElement(material_1.Grid, { container: true },
            React.createElement(material_1.Grid, { item: true, xs: 4 },
                React.createElement(material_1.Box, { paddingBottom: "2em", paddingLeft: "1em", paddingRight: "1em" },
                    React.createElement(react_slick_1["default"], __assign({}, settings), product.images.map(function (image) { return (React.createElement("div", { className: "product-f-details-imgwrapper", key: "fullDetail-" + image },
            ...
            React.createElement(material_1.Grid, { item: true, xs: 8 },
                React.createElement(material_1.Box, { className: "product-f-details mainInfo", textAlign: "left" },
                    React.createElement(material_1.Typography, { className: "product-f-details title" }, product.title),
                ...
                React.createElement(material_1.Box, null,
                    React.createElement(material_1.Typography, { variant: "subtitle1", textAlign: "left" }, product.description))))));
};
exports["default"] = ProductFullDetails;
