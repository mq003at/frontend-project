    ...
    return (
      <Card className="product-f-details wrapper">
        <Box className="product-f-details show-cat" textAlign={"left"}>
          <Typography  marginLeft={"1.25em"} padding={"0.5em 0.5em"} color="text.secondary">{">"} {cartProduct.product.category.name}</Typography>
        </Box>
        ...
        <Grid container>
          ...
          <Grid item xs={8}>
            ...
            <Box className="product-f-details buyout-container">
              ...
              <Button className="product-f-details shopIcon" onClick={() => handleButton()}><DoneIcon/></Button>
            </Box>
            <Box>
